% ------------------------------------------------------------------------------
% TYPO3 CMS 8.3 - What's New - Chapter "Sources" (Serbian Version)
%
...
% ------------------------------------------------------------------------------
% LTXE-SLIDE-START
% LTXE-SLIDE-UID:		ff9dd80d-20cf3b9f-edf2d5b3-8a94e202
...
\begin{frame}[fragile]
	...
	\textbf{Informacije o izlasku nove verzije:}
		\begin{itemize}\smaller
			...
			\item \texttt{typo3/sysext/core/Documentation/Changelog/8.2/*} i \texttt{/8.3/*}
		\end{itemize}
	...
	\textbf{TYPO3 i Fluid Git Repositories:}
		\begin{itemize}\smaller
...
% ------------------------------------------------------------------------------
% LTXE-SLIDE-START
% LTXE-SLIDE-UID:		340074b6-0ec8c970-1ffef104-368a122b
