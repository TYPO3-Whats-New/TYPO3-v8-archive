% ------------------------------------------------------------------------------
% TYPO3 CMS 8.3 - What's New - Chapter "Sources" (French Version)
%
...
% ------------------------------------------------------------------------------
% LTXE-SLIDE-START
% LTXE-SLIDE-UID:		3e94d1e2-e290eb1e-577457ee-3543c5fc
...
\begin{frame}[fragile]
	...
	\textbf{Informations des sorties~:}
		\begin{itemize}\smaller
			\item \url{http://wiki.typo3.org/TYPO3_CMS_8.2.0} et \texttt{\href{http://wiki.typo3.org/TYPO3_CMS_8.3.0}{TYPO3\_CMS\_8.3.0}}
			...
			\item \texttt{typo3/sysext/core/Documentation/Changelog/8.2/*} et \texttt{/8.3/*}
		\end{itemize}
...
% ------------------------------------------------------------------------------
% LTXE-SLIDE-START
% LTXE-SLIDE-UID:		5c938b1b-dc7b0c99-9e27ac7f-d2fb6100
