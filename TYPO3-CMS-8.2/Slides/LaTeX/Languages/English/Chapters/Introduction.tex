% ------------------------------------------------------------------------------
% TYPO3 CMS 8.2 - What's New - Chapter "Introduction" (English Version)
%
...
% ------------------------------------------------------------------------------
% LTXE-SLIDE-START
% LTXE-SLIDE-UID:		de1d09f3-1b80b171-45e65f78-cbf750bc
% LTXE-SLIDE-TITLE:		TYPO3 CMS 8.2 - The Facts
% ------------------------------------------------------------------------------
\begin{frame}[fragile]
	\frametitle{Introduction}
	\framesubtitle{TYPO3 CMS 8.2 - The Facts}
	...
	\begin{figure}
		\includegraphics[width=0.95\linewidth]{Introduction/typo3cms82-banner.png}
	\end{figure}
...
% ------------------------------------------------------------------------------
% LTXE-SLIDE-START
% LTXE-SLIDE-UID:		29730fa0-cfb7b672-9541b86e-5d979dcc
...
% ------------------------------------------------------------------------------
% LTXE-SLIDE-START
% LTXE-SLIDE-UID:		c5361815-a40c49e2-c6fe93fe-0e0b9466
...
% ------------------------------------------------------------------------------
% LTXE-SLIDE-START
% LTXE-SLIDE-UID:		99e5aeb9-52a34013-e7784c4c-9ff8f701
...
\begin{frame}[fragile]
	...
	\begin{itemize}
		...
		\item
			\begingroup
				\color{typo3orange}
					v8.2 \tabto{1.1cm}05/Jul/2016\tabto{3.4cm}Rich Text Editor
			\endgroup
...
% ------------------------------------------------------------------------------
% LTXE-SLIDE-START
% LTXE-SLIDE-UID:		3159ba35-9542333b-a0495cfc-af0010a5
...
\begin{frame}[fragile]
	...
	\begin{itemize}
		...
		\begin{lstlisting}
			$ cd /var/www/site
			$ wget --content-disposition get.typo3.org/8.2
			$ tar xzf typo3_src-8.2.0.tar.gz
			$ cd htdocs
			$ ln -s ../typo3_src-8.2.0 typo3_src
...
% ------------------------------------------------------------------------------
% LTXE-SLIDE-START
% LTXE-SLIDE-UID:		d3497bd8-61e5242f-0009b322-3a285ed7
...
\begin{frame}[fragile]
	...
	\begin{itemize}
		...
		\item Upgrade instructions:\newline
			\smaller\url{http://wiki.typo3.org/Upgrade#Upgrading_to_8.2}\normalsize
...
% ------------------------------------------------------------------------------
% LTXE-SLIDE-START
% LTXE-SLIDE-UID:		31bb3281-23ea7e95-5ed92903-61de52e7
