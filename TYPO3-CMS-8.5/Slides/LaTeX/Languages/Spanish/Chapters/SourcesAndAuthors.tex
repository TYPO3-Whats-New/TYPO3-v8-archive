% ------------------------------------------------------------------------------
% TYPO3 CMS 8.5 - What's New - Chapter "Sources" (Spanish Version)
%
...
% ------------------------------------------------------------------------------
% LTXE-SLIDE-START
% LTXE-SLIDE-UID:		05a029f3-949d6d72-2cc825d5-95bac7a6
...
\begin{frame}[fragile]
	...
	\textbf{Repositorios Git TYPO3 y Fluid:}
		\begin{itemize}\smaller
...
% ------------------------------------------------------------------------------
% LTXE-SLIDE-START
% LTXE-SLIDE-UID:		fc074341-a30ddb97-805fba9d-a8e16b8b
...
\begin{frame}[fragile]
	...
	\smaller\begin{center}Licenciado bajo Creative Commons BY-NC-SA 3.0\end{center}\normalsize
